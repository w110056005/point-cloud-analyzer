...
def show_registration_result(
    ...
    multpoint = mix_point_cloud(pcd_source_dense_centered,pcd_target_dense_centered)
    #o3d.io.write_point_cloud('new_cloud_bin.pcd',multpoint)
    
    #o3d.visualization.draw_geometries([multpoint])
